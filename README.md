...
- **Тяга** — ползунок мощности ESC (0–100 %). Активен только в состоянии **Arm**.

### Управление приводом

1. Подключитесь к стенду.
2. Нажмите **Arm** — привод переводится в режим готовности.
3. Двигайте **тягу** для изменения мощности.
4. Для эксренной остановки нажмите **Disarm** — мощность сбрасывается в ноль.
